...
class Detect(Module, common.Filters, common.PackageManager, common.Provider, common.Strings, common.FileSystem, common.ZipFile):
    ...
    def execute(self, arguments):
        ...
        if arguments.package != None and arguments.component != None:
            ...
            try:
                start_components.startcomponent(arguments.package, arguments.component, SEND_BROADCAST, self.getContext())
            ...
            self.stdout.write("package or component could not be None\n'")
        shell.close()
