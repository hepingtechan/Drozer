...
class Detect(Module, common.Filters, common.PackageManager, common.Provider, common.Strings, common.FileSystem, common.ZipFile):
    ...
    def execute(self, arguments):
        ...
        if arguments.package != None:
            ...
            with open('detect_result/'+arguments.package+'_content_provider.txt', 'w') as file_detect_result:
                for uri in self.findAllContentUris(arguments.package):
                    ...
                    try:
                        ...
                        output = "    Could not query from URI %s \n" % uri
                        self.stdout.write(output)
                        file_detect_result.write(output)
                        continue
                    ...
                    if cursor != None:
                        ...
                        output = "    Accessible Tables From URI: %s \n" % uri
                        self.stdout.write(output)
                        file_detect_result.write(output)
                        ...
                        output = "    Accesible but Query Result is None!!!\n"
                        self.stdout.write(output)
                        file_detect_result.write(output)
